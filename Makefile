...
#CROSS_COMPILE	?= /media/linux/broodROM-JB2/prebuilts/gcc/linux-x86/arm/arm-eabi-4.6/bin/arm-eabi-
#CROSS_COMPILE	?= /media/linux/linarotoolchain/bin/arm-cortex_a9-linux-gnueabi-
CROSS_COMPILE	?= /media/linux/linarotoolchain/bin/arm-eabi-
